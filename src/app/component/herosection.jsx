...
const HeroSection = () => {
  return (
    <section
      id="hero-area"
      className="bg-[#3b82f6] text-white py-12 px-4 mx-auto rounded-lg mt-[90px] flex items-center justify-center"
      style={{ maxWidth: '100%', minHeight: '400px' }} // Set maxWidth to 100% and minHeight for section height
    >
      <div className="mx-auto "> {/* Limit width for larger screens */}
          ...
          <div className="w-full lg:w-1/2">
            <div className="header-content">
              ...
              <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-4">
                <Link href="#">
                  <span className="btn primary-btn bg-white text-blue-600 px-8 py-3 rounded-full font-bold shadow-lg hover:bg-gray-200 transition">
                    Get Started
                  </span>
                </Link>
